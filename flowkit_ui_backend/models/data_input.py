...
class DataInput(BaseModel):
    ...
    DataInput - a model defined in OpenAPI

        spatial_unit_ids: The spatial_unit_ids of this DataInput.
        data: The data of this DataInput.
    """
